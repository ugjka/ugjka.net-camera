...
#links = [('Home', 'https://ugjka.net/'),
#        ('About', 'https://ugjka.net/about/')]
...
#files_to_copy = (('../extra/extra.css', 'extra.css'), 
#               ('../extra/background.png', 'static/background.png'),)
